...
export const vectorExplorerModule = {
    ...
    // Random integer vector, clamped so its tip always lands within the currently visible plane
    addRandomVector() {
    ...
    draw(ctx) {
        ...
        // Independent random extras, drawn first so the main A/B/R trio always renders on top and stay visually primary.
